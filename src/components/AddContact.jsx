                ...
                <div className="row">
                    <div className="col-md-4">
                        <form onSubmit={submitForm}>
                            ...
                            <div className='mb-2'>
                                <input type="text" className='form-control' placeholder='Photo Url' required={true} name='photo'
                                    onChange={updateinput} value={contact.photo} />
                            </div>

                            <div className='mb-2'>
                                <input type="number" className='form-control' placeholder='Mobile No' required={true} name='mobile'
                                    onChange={updateinput} value={contact.mobile} />
                            </div>

                            <div className='mb-2'>
                                <input type="email" className='form-control' placeholder='Email' required={true}
                                    name='email'
                                    onChange={updateinput} value={contact.email} />
                            </div>

                            <div className='mb-2'>
                                <input type="text" className='form-control' placeholder='Company' required={true} name='company'
                                    onChange={updateinput} value={contact.company} />
                            </div>

                            <div className='mb-2'>
                                <input type="text" className='form-control' placeholder='title' required={true} name='title'
                                    onChange={updateinput} value={contact.title} />
                            </div>
                            <div className='mb-2'>
